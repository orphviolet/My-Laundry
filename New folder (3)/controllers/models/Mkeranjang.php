...
class Mkeranjang extends CI_Model{
    ...
    function checkout($keranjang, $member_jual, $member_beli, $nama_ekspedisi, $ongkirterpilih){
            ...
            $m['distrik_pengiriman'] = $member_jual['nama_distrik_member'];
            $m['nama_pengiriman'] = $member_jual['nama_member'];
            ...
            $m['estimasi_ekspedisi'] = $nama_ekspedisi;
            $m['berat_ekspedisi'] = $ongkirterpilih['description'];
            $m['layanan_ekspedisi'] = $ongkirterpilih['cost'][0]['value'];
            $m['nama_ekspedisi'] = $totalberat;
